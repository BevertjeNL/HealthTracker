...
export const healthMetrics = pgTable(
  "health_metrics",
  {
    ...
    oxygenSaturationPct: real("oxygen_saturation_pct"),
    respiratoryRate: real("respiratory_rate"),
    exerciseMinutes: real("exercise_minutes"),
    daylightMinutes: real("daylight_minutes"),
    walkingSpeedKmh: real("walking_speed_kmh"),
    walkingSteadinessPct: real("walking_steadiness_pct"),
    sixMinuteWalkDistanceM: real("six_minute_walk_distance_m"),
    runningPowerW: real("running_power_w"),
    runningStrideLengthM: real("running_stride_length_m"),
    runningVerticalOscillationCm: real("running_vertical_oscillation_cm"),
    runningGroundContactTimeMs: real("running_ground_contact_time_ms"),
    raw: jsonb("raw"),
    createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
  },
